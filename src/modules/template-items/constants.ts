...
export const templateItemsCopy = {
    ...
    title: 'Items',
    description:
        'This module is intentionally small but complete: filters, detail view, child records, batch actions, create, update and delete. Replace the entity shape, keep the control flow.',
